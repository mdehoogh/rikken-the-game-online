...
module.exports=(socket_io_server,gamesListener,acknowledgmentRequired)=>{
    ...
    class EventSender{
        ...
        setEventToSend(eventToSend){
            ...
            if(this._eventToSend&&!this._intervalId)this._intervalId=setInterval(this._sendAgain,interval);
            if(!this._eventToSend&&this._intervalId){clearInterval(_intervalId);this._intervalId=null;}
            return true;
        }
        ...
        acknowledged(eventId){
            ...
            if(this._eventToSend&&this._eventToSend._id==eventId)this._sendEvent(null);
